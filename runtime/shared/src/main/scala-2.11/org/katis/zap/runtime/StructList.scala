...
class StructList[S <: Struct : StructFromSegment : HasStructSize : SetPointerBuilder] extends org.katis.zap.runtime.List[S#Builder, S#Reader](ElementSize.INLINE_COMPOSITE) {
