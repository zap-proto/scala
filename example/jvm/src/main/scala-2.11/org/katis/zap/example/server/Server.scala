package org.katis.zap.example.server
...
import org.katis.zap.example.server.ZapExts._
import org.katis.zap.example.todo.ServerMessage.{Add, Modify, Remove}
import org.katis.zap.example.todo._
import org.katis.zap.runtime.implicits._
import org.katis.zap.runtime.{MessageBuilder, MessageStreamParser, Serialize}
...
object Server {
  def main(args: Array[String]): Unit = {
    implicit val system = ActorSystem("zap-example")
