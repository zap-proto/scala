...
import org.katis.zap.runtime.{MessageReader, Text}
...
class Generator(val request: CodeGeneratorRequest#Reader) {
  ...
  def structTypePreamble(nodeId: Long, data: Int, pointers: Int) = Seq(Indent(Branch(
    ...
    Line(s"override val structSize: org.katis.zap.runtime.StructSize = new org.katis.zap.runtime.StructSize($data, $pointers)"),
    BlankLine,
    Line("override type Reader = ReaderImpl"),
    Line("override type Builder = BuilderImpl"),
    BlankLine,
    Line("override val Builder: (org.katis.zap.runtime.SegmentBuilder, Int, Int, Int, Short) => Builder = new BuilderImpl(_, _, _, _, _)"),
    Line("override val Reader: (org.katis.zap.runtime.SegmentReader, Int, Int, Int, Short, Int) => Reader = new ReaderImpl(_, _, _, _, _, _)"),
    BlankLine)
  ))
  ...
  def generateOutput(nodeId: Long): Seq[String] = {
    ...
    val lines = Vector("// GENERATED ZAP FILE, DO NOT EDIT",
  ...
  def genericParamWithConstraints(paramName: String): String = {
    s"$paramName <: org.katis.zap.runtime.PointerFamily : org.katis.zap.runtime.FromPointer : org.katis.zap.runtime.SetPointerBuilder"
  }
    ...
    nodeReader match {
      ...
      case Struct(struct) =>
        ...
        if (isGeneric && parameters.nonEmpty) {
          ...
          output += Line(s"sealed class $nodeName[$genericParamsDecls] private() extends org.katis.zap.runtime.Struct { ")
        } else {
          output += Line(s"object $nodeName extends $nodeName")
          output += Line(s"sealed class $nodeName private() extends org.katis.zap.runtime.Struct { ")
        }
        ...
        implicits ++= {
          ...
          Seq(
            ...
            Branch(
              Line(s"implicit $define $implicitNamePrefix$$$$HasTypeId$defParams = new org.katis.zap.runtime.HasTypeId[$fullType] {"),
              Indent(Line(s"def typeId: Long = ${nodeId}L")),
              Line("}")
            ),
            Branch(
              Line(s"implicit $define $implicitNamePrefix$$$$HasStructSize$defParams = new org.katis.zap.runtime.HasStructSize[$fullType] {"),
              Indent(Line(s"val structSize = new org.katis.zap.runtime.StructSize($dataSize, $pointerSize)")),
              Line("}")
            ),
            Line(s"implicit $define $implicitNamePrefix$$$$StructFromSegment$defParams = new org.katis.zap.runtime.StructFromSegment[$fullType] {"),
            Indent(Branch(
              Line(s"def readerFromSegment(segment: org.katis.zap.runtime.SegmentReader, dataOffset: Int, pointers: Int, dataSize: Int, pointerCount: Short, nestingLimit: Int): $fullType#Reader = {"),
              Indent(Line(s"$fullPath.Reader(segment, dataOffset, pointers, dataSize, pointerCount, nestingLimit)")),
              Line("}"),
              Line(s"def builderFromSegment(segment: org.katis.zap.runtime.SegmentBuilder, dataOffset: Int, pointers: Int, dataSize: Int, pointerCount: Short): $fullType#Builder = {"),
        ...
        output += Indent(Branch(
          Line("class ReaderImpl(_segment: org.katis.zap.runtime.SegmentReader, _dataOffset: Int, _pointers: Int, _dataSize: Int, _pointerCount: Short, _nestingLimit: Int) extends super.ReaderBase(_segment, _dataOffset, _pointers, _dataSize, _pointerCount, _nestingLimit) {"),
          Indent(Branch(readerMembers:_*)),
          Line("}")
        ))
        output += Indent(Branch(
          Line("class BuilderImpl(_segment: org.katis.zap.runtime.SegmentBuilder, _dataOffset: Int, _pointers: Int, _dataSize: Int, _pointerCount: Short) extends super.BuilderBase(_segment, _dataOffset, _pointers, _dataSize, _pointerCount) {"),
      ...
      case Enum(enumReader) =>
        ...
        implicits ++= Seq(
          ...
          Branch(
            Line(s"implicit $definition $implicitPrefix$$$$EnumValues$genericParams = new org.katis.zap.runtime.HasEnumValues[$enumTypePath] {"),
            Indent(Line(s"val enumValues = $enumModulePath.enumValues")),
            Line("}")
          ),
          Branch(
            Line(s"implicit $definition $implicitPrefix$$$$FromShort$genericParams = new org.katis.zap.runtime.FromShort[$enumTypePath] {"),
        ...
        output += Branch(
          Line(s"sealed class $enumClassName(index: Short) extends org.katis.zap.runtime.Enum(index)"),
          Line(s"object $enumClassName extends org.katis.zap.runtime.EnumModule[$enumClassName] {"),
          Indent(Branch(
            Branch(
    ...
    field match {
      ...
      case Slot(regField) =>
        ...
        val getterCode = (rawType, default) match {
          case (Type.Void(), Value.Void()) => Line("org.katis.zap.runtime.Void")
          ...
          case (Type.Text(), Value.Text(_)) => Line(getPointerField("org.katis.zap.runtime.Text", offset))
          case (Type.Data(), Value.Data(_)) => Line(getPointerField("org.katis.zap.runtime.Data", offset))
          ...
          case (Type.AnyPointer(_), _) =>
            if (rawType.isParameter) {
              ...
              Line(getPointerField("org.katis.zap.runtime.AnyPointer", offset))
            }
    ...
    val maybeBuilderType: Option[String] = field match {
      ...
      case Field.Slot(regField) =>
        ...
        typ match {
          ...
          case Type.Text() =>
            initterInterior += Line(s"_initPointerField[org.katis.zap.runtime.Text]($offset, size)")
            initterParams += "size: Int"
            Some("org.katis.zap.runtime.Text#Builder")
          ...
          case Type.AnyPointer(Type.AnyPointer.Unconstrained()) =>
            initterInterior += Line(s"_initPointerField[org.katis.zap.runtime.AnyPointer]($offset, size)")
            initterParams += "size: Int = 0"
            Some("org.katis.zap.runtime.AnyPointer#Builder")
          case Type.Data() =>
            initterInterior += Line(s"_initPointerField[org.katis.zap.runtime.Data]($offset, size)")
            initterParams += "size: Int"
            Some("org.katis.zap.runtime.Data#Builder")
          case Type._List(_) =>
      ...
      case Field.Slot(regField) =>
        ...
        typ match {
          ...
          case _ if typ.isPrimitive =>
            ...
            Some(tstr)
          case Type.Text() =>
            setterInterior += Line(s"""_setPointerField[org.katis.zap.runtime.Text]($offset, value)""")
            textSetterInterior = Some(Line(s"_setPointerField[org.katis.zap.runtime.Text]($offset, org.katis.zap.runtime.Text.Reader(value))"))
            Some("org.katis.zap.runtime.Text#Reader")
          case Type.AnyPointer(Type.AnyPointer.Parameter(parameter)) =>
            val struct = nodeMap(parameter.scopeId)
            val paramName = struct.parameters(parameter.parameterIndex).name.toString
          ...
          case Type.AnyPointer(Type.AnyPointer.Unconstrained()) =>
            Some("org.katis.zap.runtime.AnyPointer#Reader")
          case Type.Data() =>
            setterInterior += Line(s"""_setPointerField[org.katis.zap.runtime.Data]($offset, value)""")
            Some("org.katis.zap.runtime.Data#Reader")
          case Type._List(_) =>
            val elementFactory = typeString(typ, Leaf.Module)
          ...
          val mpart = scopeMap.get(node.id) match {
            case Some(scope) =>
              ...
              val arguments = brandScopes.get(nodeId) match {
                case None => params.map(_ => s"org.katis.zap.runtime.AnyPointer.$leaf")
                ...
                case Some(Brand.Scope.Bind(bindingsList)) =>
                  ...
                  bindingsList.map {
                    case v if booleanMatch(v){case Brand.Binding.Unbound() =>} =>
                      s"org.katis.zap.runtime.AnyPointer.$leaf"
  ...
  def modulePath(typ: Type#Reader, module: Leaf, separator: String): String = {
    ...
    import Type._
    val path = typ match {
      case Void() => "org.katis.zap.runtime.Void"
      case Bool() => "Boolean"
      case Int8() => "Byte"
      case Int16() => "Short"
      case Int32() => "Int"
      ...
      case Float32() => "Float"
      case Float64() => "Double"
      case Type.Text() => s"org.katis.zap.runtime.Text$moduleSuffix"
      case Data() => s"org.katis.zap.runtime.Data$moduleSuffix"
      case Struct(st) =>
      ...
      case AnyPointer(anyPointer) =>
        ...
        anyPointer match {
          ...
          case _ =>
            module match {
              case Leaf.Reader => "org.katis.zap.runtime.AnyPointer#Reader"
              case Leaf.Builder => "org.katis.zap.runtime.AnyPointer#Builder"
              case Leaf.Module => "org.katis.zap.runtime.AnyPointer"
              case _ => ???
            }
        }
    }
  ...
  def listModulePath(elementType: Type#Reader, module: Leaf, separator: String): String = {
    ...
    import Type._
    elementType match {
      case Struct(_) => s"org.katis.zap.runtime.StructList[${typeString(elementType, Leaf.Module)}]$moduleSuffix"
      case Enum(_) => s"org.katis.zap.runtime.EnumList[${typeString(elementType, Leaf.Module)}]$moduleSuffix"
      case Type.Text() => s"org.katis.zap.runtime.TextList$moduleSuffix"
      case Data() => s"org.katis.zap.runtime.DataList$moduleSuffix"
      case _List(_) => s"org.katis.zap.runtime.ListList[${typeString(elementType, Leaf.Module)}]$moduleSuffix"
      case AnyPointer(_) => throw new NotImplementedError("Anypointer lists are not implemented")
      case _ if elementType.isPrimitive => s"org.katis.zap.runtime.PrimitiveList$separator${typeString(elementType, Leaf.Module)}$moduleSuffix"
    }
  }
}
